...
public class BraveSigninManager implements SigninManager {
    ...
    @Override
    public void signinAndEnableSync(CoreAccountInfo coreAccountInfo,
            @SigninAccessPoint int accessPoint, @Nullable SignInCallback callback) {}
    ...
    @Override
    public void signin(CoreAccountInfo coreAccountInfo, @SigninAccessPoint int accessPoint,
            @Nullable SignInCallback callback) {}
}
