...
'../components/extension/pending_transaction_panel/pending_transaction_panel'
import {
  PendingSignatureRequestsPanel
} from
'../components/extension/pending_signature_requests_panel/pending_signature_requests_panel'
